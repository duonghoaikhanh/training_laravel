            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('team/update', ['id' => $team->id]) }}">
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="description" type="text" class="form-control" name="description" value="{{ $team->description }}" required autofocus>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                        ...
                                        @foreach($members as $member)
                                            <tr role="row" class="odd">
                                                <td class="sorting_1">
                                                    <input type="checkbox" value="{{$member->id}}" @if(in_array($member->id, $idsMember)) checked @endif name="memberIds[]">
                                                </td>
