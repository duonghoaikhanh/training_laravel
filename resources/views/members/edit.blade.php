                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('member/update', ['id' => $member->id]) }}">
                            ...
                            <div class="form-group{{ $errors->has('fullname') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="fullname" type="text" class="form-control" name="fullname" value="{{ $member->fullname }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" value="{{ $member->birthday }}" name="birthday" class="form-control pull-right" id="birthday" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="role">
                                        @foreach($roles as $role)
                                            <option {{ $member->role == $role->id ? 'selected' : ''  }} value="{{$role->id}}">{{$role->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
